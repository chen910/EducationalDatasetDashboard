...
const HSCHOOL_URL = 'https://data.cityofchicago.org/api/views/qemx-3d9f/rows.csv';
const DSCHOOL_URL = 'https://data.cityofchicago.org/api/views/kqmn-byj8/rows.csv';
